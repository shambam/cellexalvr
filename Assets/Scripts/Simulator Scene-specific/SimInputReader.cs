...
// public class SimInputReader  : MonoBehaviour{
//
...
//
//
//         string[] txtList = Directory.GetFiles(Directory.GetCurrentDirectory() + Path.DirectorySeparatorChar + "Assets\\Data\\runtimeGroups", "*.txt");
